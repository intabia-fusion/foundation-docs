...
We've seen how we can [create variations of a Type](/ru/cards/types/creating-types/#creating-derived-types). But what if we want to define some kind of behavior or functionality without altering the core structure of the Type itself? 
...
In our next guide, we'll learn how to create the Tags we just described. Check out [Creating Tags](/ru/cards/tags/creating-tags) to get started!
