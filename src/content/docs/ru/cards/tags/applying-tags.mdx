...
Now that we've learned about [Tags](/foundation-docs/ru/cards/tags/tags-overview) and how to [create](/foundation-docs/ru/cards/tags/creating-tags) them, let's explore how to apply them to our Cards. First, you'll need to create a Card from a Type that has Tags. If you haven't already, check out our guides on [creating Cards](/foundation-docs/ru/cards/creating-cards).
