...
Now that we've learned about [Tags](/ru/cards/tags/tags-overview) and how to [create](/ru/cards/tags/creating-tags) them, let's explore how to apply them to our Cards. First, you'll need to create a Card from a Type that has Tags. If you haven't already, check out our guides on [creating Cards](/ru/cards/creating-cards).
...
<Image src={tags} alt="Adding a Tag to a Card" inferSize />
