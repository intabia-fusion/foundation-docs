...
You can use Cards to completely replace [Documents](/ru/knowledge-management/documents) in your workspace — or use them both simultaneously for different purposes. Let’s take a look at the key similarities and differences between Documents and Cards.
