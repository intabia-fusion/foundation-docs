---
title: Recruiting
description: Learn how to leverage the recruiting module in Foundation to manage job vacancies, applications and talents.
---
...
Foundation's recruiting module can be used to manage job vacancies, applications and talents within your workspace. Like other Foundation modules, recruiting is interwoven with the rest of your workspace, allowing you to connect your recruiting data to your task tracker and chats.
...
* **Collaborators** - collaborators will receive notifications related to any activity on the vacancy (learn more about [collaborators](/foundation-docs/ru/task-tracking/issue-collaborators))
...
* **Related issues** - See all issues from your Tracker that are related to the vacancy, or create a new related issue (learn more about [related issues](/foundation-docs/ru/task-tracking/related-issues)).
...
In Foundation, **talents** are a type of contact. Talents can be connected to **vacancies** through **applications**. 
...
From here you can add any properties you'd like. For more on how to add properties to classes, see [Classes and enums](/foundation-docs/ru/advanced-settings/classes-enums).
