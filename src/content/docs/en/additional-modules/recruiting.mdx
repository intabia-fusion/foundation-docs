...
* **Collaborators** - collaborators will receive notifications related to any activity on the vacancy (learn more about [collaborators](/foundation-docs/en/task-tracking/issue-collaborators))
...
* **Related issues** - See all issues from your Tracker that are related to the vacancy, or create a new related issue (learn more about [related issues](/foundation-docs/en/task-tracking/related-issues)).
...
From here you can add any properties you'd like. For more on how to add properties to classes, see [Classes and enums](/foundation-docs/en/advanced-settings/classes-enums).
