---
title: Recruiting
description: Learn how to leverage the recruiting module in Intabia Platform to manage job vacancies, applications and talents.
---
...
Intabia Platform's recruiting module can be used to manage job vacancies, applications and talents within your workspace. Like other Intabia Platform modules, recruiting is interwoven with the rest of your workspace, allowing you to connect your recruiting data to your task tracker and chats.
...
* **Collaborators** - collaborators will receive notifications related to any activity on the vacancy (learn more about [collaborators](/en/task-tracking/issue-collaborators))
...
* **Related issues** - See all issues from your Tracker that are related to the vacancy, or create a new related issue (learn more about [related issues](/en/task-tracking/related-issues)).
...
In Intabia Platform, **talents** are a type of contact. Talents can be connected to **vacancies** through **applications**. 
...
From here you can add any properties you'd like. For more on how to add properties to classes, see [Classes and enums](/en/advanced-settings/classes-enums).
