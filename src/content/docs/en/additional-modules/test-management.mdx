...
description: Learn how to create, manage and run tests in Intabia Platform.
---
...
Intabia Platform's test management module enables you to efficiently create, organize, and run tests within your workspace. With this module, you can track test statuses, view results, link tests to issues in the Tracker, and generate work tickets for assignees.
