...
Intabia Platform offers a high degree of configurability through Classes. A class is a set or category of things having some property in common. In other words, classes are a way to group objects together based on shared properties.
