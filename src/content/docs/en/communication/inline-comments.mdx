...
Inline comments are different from comments found in the Activity section at the bottom of a document, issue or other Intabia Platform object. These are the key differences:
