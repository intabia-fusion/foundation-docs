---
title: Notifications
description: Learn how to control the kinds of notifications you'll receive from Intabia Platform.
---
...
For more granular control over the kinds of notifications you'll receive, select a space or object from the list in the left sidebar. There, you can select which kinds of updates you'd like to receive notifications for, as well as how you'd like to receive them — in your inbox, by email, and/or push.