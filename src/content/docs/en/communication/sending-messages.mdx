...
Intabia Platform offers many options for team members to communicate directly within the platform without the need for an external app. The chat functionality allows team members to exchange messages in real time through direct messaging and shared channels. 
...
There are a few different ways to chat with team members in Intabia Platform:
...
* A green dot next to a user's avatar indicates that they are online and have their workspace open.
...
Like everywhere else in your workspace, chat messages support markdown formatting, attachments, mentions, emojis and text templates. 
