...
* **Transcription** - Toggle transcription on or off. For more on how Foundation's AI assistant Julia AI transcribes meetings in real-time, see [Transcription](/en/communication/transcription).
