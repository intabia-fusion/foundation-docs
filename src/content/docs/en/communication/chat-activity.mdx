...
Outside of Chat, you'll notice that many objects in Foundation (like issues and documents) have an Activity section where you can have discussions through comments. Comments that are added here in the Activity section will also appear in the chat associated with that object.
