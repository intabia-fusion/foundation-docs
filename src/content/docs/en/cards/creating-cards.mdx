...
Spaces for Cards act like any other space in Foundation, meaning you can leave, join and archive spaces, and global admin roles will apply. For more on managing permissions at the workspace and space level, see our guide on [Roles and Permissions](/en/advanced-settings/roles).
...
* [File Types](/en/cards/types/file-types) - Manage images, videos, PDFs, and other media within Foundation's default `File` Type.
