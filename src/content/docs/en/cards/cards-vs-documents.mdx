...
You can use Cards to completely replace [Documents](/en/knowledge-management/documents) in your workspace — or use them both simultaneously for different purposes. Let’s take a look at the key similarities and differences between Documents and Cards.
...
> **Note:** While our initial implementation of Cards is focused on knowledge management, Cards will also serve as the foundation for many other features on the platform, including process management and threads. With Cards, you'll be able to build your own custom applications within Intabia Platform, such as a CRM, CMS, project management system and more. Stay tuned for more updates soon!
