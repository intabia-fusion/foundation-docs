...
<Image src={typesOverview} alt="Overview of Types settings" inferSize />
...
> **Note:** Properties can also be added directly to Cards — see [Creating Cards](/en/cards/creating-cards).
...
<Image src={createEnum} alt="Creating an enum" inferSize />
...
<Image src={derivedTypes} alt="Derived Types" inferSize />
