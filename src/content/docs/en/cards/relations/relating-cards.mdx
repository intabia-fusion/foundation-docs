...
After setting up [Relations](/en/cards/relations/defining-relations), you can start relating Cards to each other.
...
<Image src={characterRelationsCard} alt="Relations on a Character Card" inferSize />

> **Note:** It is currently possible to create a relation to a Person or Company in your Intabia Platform workspace. Soon, Persons will be replaced with Cards, allowing you to seamlessly manage your contacts within the Cards system.
...
In some cases you may want to connect parent-child Cards instead of using Relations. For more on this, see [Parent-child Cards](/en/cards/parent-child-cards).