...
After setting up [Relations](/foundation-docs/en/cards/relations/defining-relations), you can start relating Cards to each other.
...
In some cases you may want to connect parent-child Cards instead of using Relations. For more on this, see [Parent-child Cards](/foundation-docs/en/cards/parent-child-cards).