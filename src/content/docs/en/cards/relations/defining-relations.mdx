...
<Image src={relationsDialog} alt="Adding a Relation" inferSize />
...
<Image src={characterRelations} alt="Relations on the Character Type" inferSize />
...
Check out our guide on [Relating Cards](/en/cards/relations/relating-cards) to learn how to connect Cards using the Relations you've defined.