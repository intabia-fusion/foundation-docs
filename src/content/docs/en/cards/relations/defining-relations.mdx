...
Check out our guide on [Relating Cards](/foundation-docs/en/cards/relations/relating-cards) to learn how to connect Cards using the Relations you've defined.