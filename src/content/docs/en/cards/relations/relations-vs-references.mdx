...
<Image src={characterItemRelation} alt="Character Card" inferSize />

> **Below:** The `Character` is shown on the `Item` Card

<Image src={itemCharacterRelation} alt="Item Card" inferSize />
...
<Image src={characterItemRefSettings} alt="Setting a reference attribute on a Type" inferSize />

> **Below:** Select `Item` Cards on the `Character` Card using the Reference attribute

<Image src={characterItemRefCard} alt="Using a reference attribute on a Card" inferSize />
