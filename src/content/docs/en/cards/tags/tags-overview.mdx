...
We've seen how we can [create variations of a Type](/en/cards/types/creating-types/#creating-derived-types). But what if we want to define some kind of behavior or functionality without altering the core structure of the Type itself? 
...
<Image src={tagsSettings} alt="Tags Settings" inferSize />

In our next guide, we'll learn how to create the Tags we just described. Check out [Creating Tags](/en/cards/tags/creating-tags) to get started!
