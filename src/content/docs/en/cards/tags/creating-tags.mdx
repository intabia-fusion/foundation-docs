...
Click on any Tag to open it. To add a property to a Tag, click the `+` button in the properties section. Adding properties to a Tag is the same as adding properties to a Type (see [this guide](/en/cards/types/creating-types/#adding-properties)). These properties will only be available on Cards using that Tag.
...
Check out the next guide on [Applying Tags](/en/cards/tags/applying-tags) to learn how to use this Tag on a Card.