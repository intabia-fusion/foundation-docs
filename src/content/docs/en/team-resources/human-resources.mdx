...
description: Learn how to use the human resources module in Intabia Platform.
---
...
> **Note:** Intabia Platform does not currently offer pre-defined workflows for manual approval of time off requests. This feature allows team members to record their time off and remote work for visibility, rather than being integrated into a formal tracking system.
...
> **Note:** This early implementation of time tracking in Intabia Platform is still in development, so we suggest using this feature as a general guide rather than a precise tracking tool until the functionality is complete.