...
description: Learn how to set up your Foundation or TraceX workspace.
---
...
When you first sign up for an account on Foundation or TraceX, you will be prompted to create a workspace.
...
> **Note:** Under the current version of Foundation, new members are not automatically added to projects and teamspaces unless you select the `auto join` toggle for those spaces. This helps you maintain control over who has access to the data within your workspace when new members join.
...
* **Owners**: Set roles for all team members as User, Maintainer or Owner. To learn more about roles, see [this guide](/foundation-docs/en/advanced-settings/roles). 
...
A **module** is a set of features that are combined to provide a specific functionality in your workspace. For example, `Tracker`, `Documents` and `Cards` are all modules. Foundation and [TraceX](/foundation-docs/en/getting-started/introduction-tracex) come with several modules enabled by default, but you can customize your workspace by enabling or disabling modules based on your team's needs.
...
## Video tutorials: How to get started with Foundation and TraceX

The documentation here in Foundation Docs will walk you through everything you need to know about setting up your workspace in Foundation or TraceX. However, if video tutorials are more your style, checkout our getting started guides on YouTube:
