...
A space determines the settings for all of the objects within that space. Every space has a [space type](/en/advanced-settings/space-types) that defines the properties, roles, and other configurations for that space. Spaces have owners, members, and privacy settings.
