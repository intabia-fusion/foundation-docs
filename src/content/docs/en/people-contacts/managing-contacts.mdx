...
description: Learn how to manage and organize contacts in your Intabia Platform workspace.
---
...
There are three types of contacts in Intabia Platform:
...
Contacts can be added using the `+` button in the top right corner of the Contacts page. For more on adding employees to your workspace, see this guide on managing [employees](/en/people-contacts/employees).
