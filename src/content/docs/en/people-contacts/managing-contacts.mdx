...
description: Learn how to manage and organize contacts in your Foundation workspace.
---
...
There are three types of contacts in Foundation:
...
Contacts can be added using the `+` button in the top right corner of the Contacts page. For more on adding employees to your workspace, see this guide on managing [employees](/foundation-docs/en/people-contacts/employees).
