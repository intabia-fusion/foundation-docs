---
title: Drawing board
description: Learn how to use the drawing board and scribbles to enhance your collaboration in Foundation.
---
...
When collaborating on an idea, we often find ourselves reaching for a pen and paper to sketch out our thoughts. With drawing boards in Foundation, you can sketch together live with teammates, making it easy to brainstorm, plan, and visualize ideas while saving everything to your workspace.
...
To build other kinds of flow charts, diagrams and graphs, check out our guide on [diagrams](/foundation-docs/en/knowledge-management/mermaid-diagrams), which leverage MermaidJS syntax to build a variety of visualizations.

## Scribble on images

With Foundation's drawing tool, you can create any shared image into a drawing board using the scribbles feature.
