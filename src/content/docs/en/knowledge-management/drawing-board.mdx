...
To build other kinds of flow charts, diagrams and graphs, check out our guide on [diagrams](/en/knowledge-management/mermaid-diagrams), which leverage MermaidJS syntax to build a variety of visualizations.
