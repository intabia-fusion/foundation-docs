---
title: Drawing board
description: Learn how to use the drawing board and scribbles to enhance your collaboration in Intabia Platform.
---
...
When collaborating on an idea, we often find ourselves reaching for a pen and paper to sketch out our thoughts. With drawing boards in Intabia Platform, you can sketch together live with teammates, making it easy to brainstorm, plan, and visualize ideas while saving everything to your workspace.
...
With the drawing tool, you can turn any shared image into a drawing board using the scribble feature.
