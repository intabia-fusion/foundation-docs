...
- **Space type** - Currently defaults to settings optimal for Intabia Platform
...
Use `@` to tag any issue or document in Intabia Platform. Soon, all objects in Intabia Platform will be available to tag anywhere, including Drive files, teamspaces and more.

<Image src={documentMention} alt="Document mention" inferSize />
