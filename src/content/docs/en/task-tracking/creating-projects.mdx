...
description: Learn how to create a project in your Intabia Platform workspace.
---
...
> **Note:** Only workspace owners and maintainers can create projects. To learn how to grant a user special permissions, see our guide on [roles](/en/advanced-settings/roles).
