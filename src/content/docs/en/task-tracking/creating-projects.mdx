...
description: Learn how to create a project in your Foundation workspace.
---
...
> **Note:** Only workspace owners and maintainers can create projects. To learn how to grant a user special permissions, see our guide on [roles](/foundation-docs/en/advanced-settings/roles).
