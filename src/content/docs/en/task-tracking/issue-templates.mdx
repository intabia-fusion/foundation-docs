...
Templates can be changed at any time by opening the template page and editing any of the details. Just like any other issue in Intabia Platform, templates can be edited collaboratively, and any changes to the template will be recorded in the activity section of the template page.

Users can also add comments to templates, utilizing @mentions, reactions and chat threads to discuss with other team members. Activity related to templates is linked to the Intabia Platform chat and inbox modules, so you can easily keep track of any changes or updates to your templates.
